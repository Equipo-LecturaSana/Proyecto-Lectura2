...
(1, 'Cómics', 'Noticias sobre cómics y sus autores', '/IMG/imagen novedades/comics.jpg', 'comics'),
(2, 'Cine', 'Últimas novedades del cine y sus películas', '/IMG/imagen novedades/cine.jpg', 'cine'),
(3, 'Mangas', 'Todo sobre el manga y anime japonés', '/IMG/imagen novedades/mangas.jpg', 'mangas'),
(4, 'Novelas', 'Clásicos y nuevos lanzamientos de literatura', '/IMG/imagen novedades/novelas.jpg', 'novelas'),
(5, 'Biografías', 'Historias reales que inspiran al mundo', '/IMG/imagen novedades/biografias.jpg', 'biografias'),
(6, 'Fantasía', 'Mundos mágicos y aventuras épicas', '/IMG/imagen novedades/fantasia.jpg', 'fantasia')
ON DUPLICATE KEY UPDATE titulo=titulo;

-- 3. INSERTAR NOTICIAS (Ejemplos)
INSERT INTO noticia (id, apartado, titulo, descripcion, contenido, imagen, tarjeta_id) VALUES
(1,'comics','MUERE STAN LEE','El famoso escritor...','Stan Lee, creador de iconos...','/IMG/imagen novedades/ncomics1.jpg',1),
(2,'cine','EL SEÑOR DE LOS ANILLOS','La trilogía dirigida por...','Su narrativa atemporal...','/IMG/imagen novedades/ncine1.jpg',2)
ON DUPLICATE KEY UPDATE titulo=titulo;
